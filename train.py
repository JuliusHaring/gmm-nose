...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_file', type=str, default='model.pkl', help='Path to the output model file')
    ...
    train_model(args.train_file, args.model_file, args.num_components)
